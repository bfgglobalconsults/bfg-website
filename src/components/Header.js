                ...
                >
                  ...
                  <div className="py-[40px]  text-[16px] text-gray-800">
                    ...
                    <Collapsible
                      trigger={
                        <div className=" flex items-center gap-4 hover:text-[#E45F11]">
                          ...
                          <p className="font-bold py-[20px] hover:text-[#E45F11]">
                            {" "}
                            Solutions
                          </p>
                          <p>
                    ...
                    >
                      <div className="bg-[#EFEFEF] divide-y">
                        <Link
                          href="/industry/industries/consumer"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/financial"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                            Financial Services
                        ...
                        <Link
                          href="/industry/industries/hospitality"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/real-estate"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                            Real Estate
                        ...
                        <Link
                          href="/industry/industries/technology"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/government"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/oil-gas"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                            Oil and Gas
                        ...
                        <Link
                          href="/industry/industries/industrial-manufacturing"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/telecom-media"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/entertainment"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
                        ...
                        <Link
                          href="/industry/industries/health-social-care"
                          onClick={() => setShowMenu(false)}
                        >
                          <p className="text-sm ml-9 py-[20px] hover:text-[#E45F11]">
