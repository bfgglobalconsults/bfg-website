          ...
          <div className="w-full flex flex-col lg:flex-row gap-[25px]">
              ...
              <div className="flex gap-4 my-4">
                ...
                <div>
                   <Link
                        ...
                        target="_blank"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="17" cy="7" r="1.5" fill="#fff"/><g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M16 3c2.76 0 5 2.24 5 5v8c0 2.76 -2.24 5 -5 5h-8c-2.76 0 -5 -2.24 -5 -5v-8c0 -2.76 2.24 -5 5 -5h4Z"/><path d="M12 8c2.21 0 4 1.79 4 4c0 2.21 -1.79 4 -4 4c-2.21 0 -4 -1.79 -4 -4c0 -2.21 1.79 -4 4 -4"/></g></svg>
                      </Link>
                </div>
                <div>
                   <Link
                        ...
                        target="_blank"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48"><path fill="none" stroke="#fff" stroke-linejoin="round" stroke-width="3.8" d="M36 12.6h-6.013c-1.086 0-1.967.88-1.967 1.967v6.9H36l-1.169 7.597h-6.81V43h-8.776V29.064H12v-7.597h7.151l.094-7.21l-.013-1.31A7.87 7.87 0 0 1 27.099 5H36z"/></svg>
                      </Link>
                </div>
                <div>
                   <Link
                ...
                <div>
                   <Link
                        ...
                        target="_blank"
                  >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 14 14"><g fill="none"><g clip-path="url(#primeTwitter0)"><path fill="#fff" d="M11.025.656h2.147L8.482 6.03L14 13.344H9.68L6.294 8.909l-3.87 4.435H.275l5.016-5.75L0 .657h4.43L7.486 4.71zm-.755 11.4h1.19L3.78 1.877H2.504z"/></g><defs><clipPath id="primeTwitter0"><path fill="#fff" d="M0 0h14v14H0z"/></clipPath></defs></g></svg>
               </Link>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-[10px] w-[100%] lg:w-[80%]">
              <div className="text-white w-[40%] lg:w-[23%]">
                ...
                <p className="my-2 text-sm">Board of Advisors</p>
                <p className="my-2 text-sm">
              ...
              <div className="text-white w-[40%] lg:w-[23%]">
                ...
                <p className="my-2 text-sm">Consumer & Retail Market</p>
                <p className="my-2 text-sm">Hospitality & Tourism</p>
                <p className="my-2 text-sm">Financial Services</p>
                <p className="my-2 text-sm">Real Estate</p>
                <p className="my-2 text-sm">Information Technology</p>
                <p className="my-2 text-sm">Government & Non- for - Profit</p>
              </div>

              <div className="text-white w-[50%] lg:w-[23%]">
                <h3 className="font-semibold">Programs</h3>
                <p className="my-2 text-sm">SME Webinar Series</p>
                <p className="my-2 text-sm">The AI Advantage</p>

                <p className="my-2 text-sm">The Dialetics</p>
                <p className="my-2 text-sm">Emerging Marketplace Leadership Summit</p>
                <p className="my-2 text-sm">Women in Tech</p>
 
                <p className="my-2 text-sm">SME Klinic</p>
                <p className="my-2 text-sm">Tech Achievers Graduate Scheme</p>
              </div>
              ...
              <div className="text-white w-[40%] lg:w-[23%]">
                ...
                <p className="my-2 text-sm">Blogs</p>
                                <p className="my-2 text-sm">Case Studies</p>
              ...
              <div className="text-white w-[50%] lg:w-[23%]">
                ...
                <p className="my-2 text-sm">Appetizer</p>
                <p className="my-2 text-sm">Careerfun</p>
