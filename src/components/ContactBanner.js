          ...
          <div>
              <div className="w-full h-[600px] relative bg-[url('../../public/assets/contact-banner1.png')] bg-no-repeat bg-cover flex items-center">
                  <div className="p-12 w-[100%] lg:w-[60%]">
                      ...
                      <p className="text-white text-xl my-4">Our solutions position African startups and SMEs both locally and across the diaspora as the vanguard of Africa&apos;s new industrialisation era, leaving no one behind.</p>
                      <Link href="/contact">
