  ...
  <div className="bg-white w-full lg:flex items-center my-0 lg:my-[50px] py-2">
   ...
   <MediaQuery min="lg">
    ...
    <div className="w-full lg:w-[40%]  overflow-hidden py-10">
      <div className="relative h-[550px] w-[500px] ml-8">
    {/* Center logo */}
    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#E45F11] rounded-full w-52 h-52 flex items-center justify-center z-20">
      <div className="relative w-28 h-28">
        ...
        <button
          ...
          className=" absolute top-20 left-3 rounded-full p-12 text-white bg-[#000] transition-transform hover:scale-110"
        >
         ...
         <button
          ...
          className=" absolute top-16 right-5 rounded-full p-9 text-white bg-[#041926] transition-transform hover:scale-110"
        >
        ...
        <button
          ...
          className=" absolute bottom-0 left-0 rounded-full p-16 text-white bg-[#127DC0] transition-transform hover:scale-110"
        >
         ...
         <button
          ...
          className=" absolute bottom-1 right-0 rounded-full p-16 text-white bg-[#5A2608] transition-transform hover:scale-110"
        >
