...
export default function OfficeAddresses() {
  return (
    <div className="my-14">
      ...
      <div className="my-8">
        <h3 className="text-[#333] text-3xl font-semibold mb-4">
          Get in Touch with Our Team
        </h3>
        <p className="text-[#999] text-xl">
          Ready to transform your business? Contact our team at either of our
          offices. We&apos;re here to help you achieve your goals.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-[#F7F7F8] to-white p-8 rounded-2xl shadow-lg border border-[#E5E5E5] hover:shadow-xl transition-shadow duration-300">
          <div className="flex items-start gap-4 mb-6">
            <div className="p-3 bg-[#E26015] rounded-full flex-shrink-0">
              <svg
            ...
            <div className="flex-1">
              <h4 className="text-2xl font-bold text-[#333] mb-3">
                Nigeria Office
              </h4>
              ...
              <a
                ...
                className="flex items-center gap-2 text-[#E26015] hover:text-[#333] transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                ...
                <span className="font-medium">+234 818 416 5533</span>
              </a>
            </div>
          </div>
          <Link href="/ng">
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              >
                ...
                <span className="font-medium">+44 7551 107100</span>
              </a>
            </div>
          </div>
          <Link href="/uk">
            <button className="w-full mt-4 py-3 px-6 bg-[#E26015] hover:bg-[#333] text-white font-semibold rounded-lg transition-colors duration-300 flex items-center justify-center gap-2 group">
              <span>Visit UK Site</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="20"
