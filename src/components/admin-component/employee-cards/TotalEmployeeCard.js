...
const TotalEmployeeCard = ({employees}) => {
  return (
      <>
       <div className="w-[220px] bg-white shadow-md rounded-md">
        <div className="p-3">
          ...
          <h4 className="text-sm text-[#797979] my-2">Total Employee</h4>
          <p className="text-[#060606] text-2xl font-semibold">{employees?.length}</p>
          <div className="flex gap-2 items-center">
            ...
            <span className="text-[10px]">30% staff increase from last year</span>
          </div>
        </div>
      </div>
      </>
