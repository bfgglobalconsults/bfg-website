    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
        ...
        <div className="bg-white">
          <h2 className="text-xl font-bold text-gray-900 lg:text-left my-4">
            Project Status Distribution
          </h2>
          {projectStatus.map((p) => (
            <div key={p.label} className="rounded-xl shadow p-6 my-2">
              <div className="flex justify-between text-sm mb-1">
                <span>{p.label}</span>
                <span className="p-1 bg-gray-200 rounded-lg">{p.value} </span>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
        ...
        <div className="bg-white">
          ...
          {geoDist.map((g) => (
            <div key={g.label} className=" rounded-xl shadow p-6 my-2">
              <div className="flex justify-between text-sm mb-1">
                <span>{g.label}</span>
                <span className="p-1 bg-gray-200 rounded-lg">{g.value}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
        ...
        <div className="bg-white">
          ...
          {quarterlyDist.map((q) => (
            <div key={q.label} className="rounded-xl shadow p-6 my-2">
