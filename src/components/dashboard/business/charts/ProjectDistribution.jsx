...
const data = [
  { name: "Operations Transformation", value: 58, color: "#39CEF3" },
  { name: "Process Re-engineering", value: 42, color: "#98D85E" },
...
const ProjectDistribution = () => {
  ...
  return (
    <section className="bg-white shadow-md rounded-md">
      ...
      <div className="grid grid-cols-1  gap-6 my-8 p-2">
        {operationsData.map((industry, index) => (
          <div key={index} className="rounded-xl bg-white drop-shadow-2xl p-6">
