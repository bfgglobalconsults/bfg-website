...
import WhiteLogo from "../../../src/app/bfg-whitelogo.png";
  ...
  return (
    <>
      <div className="w-full bg-gradient-to-b from-[#127DC0] to-[#083B5A]">
        <div className="mx-[30px] py-[20px] lg:mx-[100px] lg:py-[50px]">
          ...
          <div className="flex flex-wrap justify-center gap-4 items-center">
            ...
            <span className="text-white text-lg">bfgconsults</span>
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            <span>
              <p className="text-white text-lg">bfgconsults.com</p>
            </span>
          </div>
        </div>
      </div>
