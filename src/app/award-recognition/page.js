            ...
            <div className="w-full flex flex-col lg:flex-row flex-wrap gap-10 my-6">
              <div className="bg-[#F7F7F8] w-[100%] lg:w-[30%] flex flex-col  items-center gap-7 p-4 lg:p-10  border rounded-2xl shadow-lg">
                ...
                <div className="w-[100%]">
                  ...
                  <p className="text-[#999]">
                    ...
                    – Recognized for outstanding contributions to global
                    business research and data-driven consulting.
                  </p>
                </div>
              </div>
              {/* second item */}
              <div className="bg-[#F7F7F8] w-[100%] lg:w-[30%] flex flex-col  items-center gap-7 p-4 lg:p-10  border rounded-2xl shadow-lg">
                ...
                <div className="w-[100%]">
                  ...
                  <p className="text-[#999]">
                    Best Start-Up & SME Consultancy Firm 2024 - West Africa by
                    the MEA Business Awards - Recognized for outstanding
                    leadership, dedication, and innovation in the consultancy
                    space for African businesses.
                  </p>
                </div>
              </div>
              {/* third item */}
              <div className="bg-[#F7F7F8] w-[100%] lg:w-[30%] flex flex-col  items-center gap-7 p-4 lg:p-10  border rounded-2xl shadow-lg">
                ...
                <div className="w-[100%]">
                  ...
                  <p className="text-[#999]">
                    Our team includes internationally certified managers,
                    accredited by the UK Chartered Management Institute (CMI)
                    ensuring world-class service delivery and leadership.
                  </p>
                </div>
              </div>
              {/* fourth item */}
              <div className="bg-[#F7F7F8] w-[100%] lg:w-[30%] flex flex-col  items-center gap-7 p-4 lg:p-10  border rounded-2xl shadow-lg">
                ...
                <div className="w-[100%]">
                  ...
                  <p className="text-[#999]">
                    Our team includes internationally certified managers,
                    accredited by the Nigerian Institute of Management
                    Consultants (NIMC) ensuring world-class service delivery and
                    leadership.
                  </p>{" "}
                </div>
              </div>
