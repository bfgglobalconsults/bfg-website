          ...
          <div>
            ...
            <div className="flex flex-col lg:flex-row w-full gap-4 justify-between my-4">
              ...
              <p className="w-[100%] lg:w-[50%] text-[#999] my-2 text-lg lg:text-xl">
                This discloses all of the ways we gathers, use, disclose, and
                manage our client&apos;s data.
              </p>
            </div>
            <div className="">
            ...
            <p className="text-[#656565]">
              ...
              <Link href="/">https://www.bfgconsults.com/</Link>, Please read
              this policy carefully to understand our policies and practices
              regarding your information and how we will treat it. If you do not
              agree with our policies and practices, please contact our company
            ...
            <div className="my-2 px-2 lg:px-10 bg-[#FCFDFD] border border-[#EEF3F6]">
              <div className="my-6">
                ...
                <p className="text-[#656565] my-2">
                  ...
                  visitors, and job applicants, which may include your name,
                  email address, phone number, company name, job title, and
                  other information you provide to us. We may also collect
                  information about your usage of our website, such as your IP
                  address and the pages you visit.
                </p>
              </div>
              <div className="my-6">
                <p className="font-bold text-xl text-black my-2">
              ...
              <div className="my-6">
                ...
                <p className="text-[#656565] my-2">
                  ...
                  law to do so, or when it is necessary to provide our services
              ...
              <div className="my-6">
                ...
                <p className="text-[#656565] my-2">
                  ...
                  they remain effective to continuously protect your data.
                </p>{" "}
              </div>
              <div className="my-6">
                <p className="font-bold text-xl text-black my-2">
              ...
              <div className="my-6">
                ...
                <p className="text-[#656565]  my-2">
                  ...
                  Policy, please contact us via the contact details displayed at
                  the foot of this webpage or the contacts on our “Contact”
                  page, or simply fill the form on the “Contact” page.
                </p>{" "}
              </div>
            </div>
            <div>
