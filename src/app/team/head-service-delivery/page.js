...
import Service from "../../../../public/assets/mr-peter.png";
    ...
    <>
      <div>
        <div className="lg:mt-[150px] p-12">
          ...
          <div className="my-4">
            <h3 className="text-3xl font-semibold my-8">Peter Chukwuemeka</h3>
          </div>
          <div className="flex flex-col lg:flex-row w-[100%] gap-8 my-8">
            <div className="w-[100%] lg:w-[20%]">
              ...
              <div className="my-8">
                <a href="mailto:peter.chukwuemeka@bfgconsults.com">
            ...
            <div className="w-[100%] lg:w-[80%]">
              ...
              <br />
              <p className="text-[#999] text-lg">
                With a proven track record of leading cross-functional teams, Peter specializes in optimizing service delivery frameworks, implementing robust project management methodologies, and identifying growth opportunities in competitive markets. His expertise in stakeholder engagement, process improvement, and strategic planning has been instrumental in achieving exceptional outcomes for BFG Global Consulting’s diverse clientele across public, private, and non-profit sectors.
              </p>
              <br />
 <p className="text-[#999] text-lg">
