                ...
                <div className="bg-white  w-[250px] p-4 shadow-md rounded-lg">
                  ...
                  <p className="text-[#E45F11]">
                    Senior Business Analyst - Organizational Strategy and Growth
                          ...
                          <div className="my-8">
                              <a href="mailto:ifeoma@bfgconsults.com">
