...
import Founder from "../../../../public/assets/festus-md.png";
    ...
    <>
      <div>
        <div className="lg:mt-[150px] p-12">
          ...
          <div className="my-4">
            <h3 className="text-3xl font-semibold my-8">Festus Bello</h3>
          </div>
          <div className="flex flex-col lg:flex-row w-[100%] gap-8 my-8">
            ...
            <div className="w-[100%] lg:w-[80%]">
              ...
              <p className="text-[#999] text-lg">
                ...
                from the International Institute of Business Analysis (IIBA) and
                he&apos;s also a Chartered Manager by the Chartered Management
                Institute (CMI) in the United Kingdom. As part of the range of
                vision-setting projects he oversees, Festus brings his
                transformational leadership and strategic acumen in spearheading
                the formulation and execution of the company&apos;s corporate
                strategy, ensuring streamlined &quot;process&quot; management,
                fostering a culture of continuous improvement of the
                company&apos;s &quot;products,&quot; and driving the excellence
                of our &quot;people&quot; in line with our company&apos;s
                corporate objective.
              </p>
              <br />
