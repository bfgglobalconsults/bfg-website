    ...
    <>
      <div>
        <div className="lg:mt-[150px] p-12">
          ...
          <div className="my-4">
            <h3 className="text-3xl font-semibold my-8">Godfrey Samuel</h3>
          </div>
          <div className="flex flex-col lg:flex-row w-[100%] gap-8 my-8">
            <div className="w-[100%] lg:w-[20%]">
              ...
              <div className="my-8">
                <a href="mailto:technology.bz@bfgconsults.com">
            ...
            <div className="w-[100%] lg:w-[80%]">
              <h4 className="text-xl font-semibold mb-6">About Godfrey</h4>
              <p className="text-[#999] text-lg">
               A Software Developer and Technology Analyst with a proven track record of delivering innovative, scalable, and efficient technology solutions. Possesses deep expertise in software architecture, full-stack development, and technology evaluation. Adept at leading cross-functional teams to design and deploy high-impact software solutions aligned with organizational objectives.
              </p>
              <br />
