...
While we are working to complete our maintenance 
          ...
          <div className="text-6xl text-center flex w-full items-center justify-center my-8">
            <div className="w-24 mx-1 p-2 bg-white text-[#037bd1] rounded-lg">
                <div className="font-mono leading-none">{timeLeft.days < 10 ? `0${timeLeft.days}` : timeLeft.days}</div>
                <div className=" uppercase text-sm leading-none">Days</div>
            </div>
            <div className="w-24 mx-1 p-2 bg-white text-[#037bd1] rounded-lg">
                <div className="font-mono leading-none">{timeLeft.hours < 10 ? `0${timeLeft.hours}` : timeLeft.hours}</div>
                <div className=" uppercase text-sm leading-none">Hours</div>
            </div>
            <div className="w-24 mx-1 p-2 bg-white text-[#037bd1] rounded-lg">
                <div className="font-mono leading-none">{timeLeft.minutes < 10 ? `0${timeLeft.minutes}` : timeLeft.minutes}</div>
                <div className=" uppercase text-sm leading-none">Minutes</div>
            </div>
            <div className="text-2xl mx-1 font-mono">and</div>
            <div className="w-24 mx-1 p-2 bg-white text-[#037bd1] rounded-lg">
                <div className="font-mono leading-none">{timeLeft.seconds < 10 ? `0${timeLeft.seconds}` : timeLeft.seconds}</div>
                <div className=" uppercase text-sm leading-none">Seconds</div>
            </div>
        </div>
        <p className="text-center text-2xl font-mono">For immediate enquiry on our services</p>
        <div className="font-mono flex justify-center gap-3">
          <p className="flex  gap-3">
          <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(255,255,255,1)"><path d="M21 16.42V19.9561C21 20.4811 20.5941 20.9167 20.0705 20.9537C19.6331 20.9846 19.2763 21 19 21C10.1634 21 3 13.8366 3 5C3 4.72371 3.01545 4.36687 3.04635 3.9295C3.08337 3.40588 3.51894 3 4.04386 3H7.5801C7.83678 3 8.05176 3.19442 8.07753 3.4498C8.10067 3.67907 8.12218 3.86314 8.14207 4.00202C8.34435 5.41472 8.75753 6.75936 9.3487 8.00303C9.44359 8.20265 9.38171 8.44159 9.20185 8.57006L7.04355 10.1118C8.35752 13.1811 10.8189 15.6425 13.8882 16.9565L15.4271 14.8019C15.5572 14.6199 15.799 14.5573 16.001 14.6532C17.2446 15.2439 18.5891 15.6566 20.0016 15.8584C20.1396 15.8782 20.3225 15.8995 20.5502 15.9225C20.8056 15.9483 21 16.1633 21 16.42Z"></path></svg></span> <span>+2348184165533</span>
          </p>
          <p className=" font-mono flex  gap-3">
