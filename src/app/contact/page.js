    ...
    <>
      <div className="lg:mt-[150px] p-12">
        ...
        <div className="flex flex-wrap gap-10 my-6">
          <div className="flex  gap-3 p-4 shadow-lg bg-[#FCFDFD] border border-[#EEF3F6] rounded-xl">
          ...
          {/* fourth item */}
          <div className="flex items-center gap-3 p-4 shadow-lg bg-[#FCFDFD] border border-[#EEF3F6] rounded-xl">
            <div className="flex flex-col">
              <div className="my-2 mx-auto inline-block p-4 bg-[#E26015] rounded-full border-4 border-[linear-gradient(180deg, rgba(255, 102, 51, 0) 73.52%, #FF6633 100%)]">
              ...
              <p className="text-[#333] text-lg font-semibold">
                Nigeria: Suite D02, Kenuj 02 Mall, <br/> Kaura District, Abuja, Nigeria.
              </p>
              <br/>
              <p className="text-[#333] text-lg font-semibold">
                UK: 12 Oxford Street, Margate,<br/> Kent, United Kingdom
              </p>
            </div>
          </div>{" "}
        </div>
