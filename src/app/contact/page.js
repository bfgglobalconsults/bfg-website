                        ...
                        <ul className="mt-12 space-y-8">
                            ...
                            <li className="flex items-center">
                                ...
                                <p className="text-white text-sm ml-3">
                                    <strong>(+234) 818 416 5533, (+44) 7551 107100</strong>
                                </p>
                            </li>
                            <li className="flex items-center">
                                ...
                                <a href="" className="text-white text-sm ml-3">
                                    <strong>The BFG Place, Suite D02, Kenuj02 Mall, Plot 1248, Kaura District, Abuja, Nigeria</strong>
                                </a>
                            </li>
                            <li className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff' viewBox="0 0 368.16 368.16">
                                ...
                                <a href="" className="text-white text-sm ml-3">
                                    <strong>20, Regency Place, Canterbury, Kent, United Kingdom</strong>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div className="bg-gray-300 p-6 rounded-lg">
                        ...
                        <form class="mt-8 space-y-4">
                            ...
                            <textarea placeholder='Message' rows="6"
                                className="w-full rounded-md px-4 text-sm pt-3 outline-[#487dc2]"></textarea>
                            <button type='button'
