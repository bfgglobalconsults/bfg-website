...
import { getIndustries, getNews, getBlogs } from "@/lib/api";
...
export default function Main() {
  ...
  useEffect(() => {
    async function fetchNews() {
      setLoadingNews(true);
      const data = await getNews(null, 3);
      setNews(data);
  ...
  useEffect(() => {
    async function fetchBlogs() {
      ...
      const data = await getBlogs(null, 3);
      setBlogs(data);
      ...
      <div className="py-[0px] lg:py-[0px] xl:py-[40px]">
        ...
        <div className="w-full h-full lg:h-[800px] flex flex-col lg:flex-row items-center flex-wrap">
          <div className="w-[100%] h-full xl:w-[40%] relative lg:flex lg:items-center lg:justify-center">
            ...
            <div className="absolute bottom-10 left-0 w-[400px] h-[200px] bg-no-repeat bg-cover bg-center bg-[url('/assets/bottom-ring.png')]"></div>
          </div>

          <div className="p-2 w-[100%] xl:w-[60%] xl:h-[800px] relative bg-[url('/assets/middle-banner.png')] bg-no-repeat">
                      ...
                      <div className="w-full flex-shrink-0 flex flex-wrap">
                        <div className="w-[100%] lg:w-[95%] lg:h-[450px] p-5 bg-white rounded-2xl">
                          <Image
                            ...
                            src={slide.imageSrc || slide.image}
                            width={500}
                            height={250}
                          />
                          <div>
                            ...
                            <Link href={slide.readMore || slide.link || "#"}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="w-full lg:h-[600px] relative bg-[url('/assets/female-middle-banner.png')] bg-cover bg-no-repeat flex items-center">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-3">
              {news.length > 0 ? (
                news.map((item) => (
                  <div
                    key={item.id}
                    className="p-4 border border-[#F7F7F8] rounded-lg w-[100%] lg:w-[30%] shadow-lg"
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-[#999] text-lg">{item.excerpt}</p>
                      <Link href={item.link}>
                ...
                <div className="w-full text-center py-8">
                  <p className="text-[#999] text-lg">No news available at the moment.</p>
                </div>
              )}
            </div>
          )}
          ...
          {loadingBlogs ? (
            ...
            <div className="w-full flex flex-col lg:flex-row gap-3">
              {blogs.length > 0 ? (
                ...
                <div className="w-full text-center py-8">
                  <p className="text-[#999] text-lg">No blogs available at the moment.</p>
                </div>
              )}
            </div>
          )}
