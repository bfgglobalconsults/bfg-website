      ...
      <div className="w-full flex justify-center py-10">
        <div className=" w-[100%] md:w-[70%] lg:w-[50%] bg-white p-4 shadow-xl">
          ...
          <p className="text-lg text-justify">
            Our product development team at The BFG Global Consulting, LLC. is
            currently open to further scale its design system and brand
            marketing operations and seeking for a young champ to take on
            full-term employment as a Junior Product Designer. Nature of job is
            Hybrid, and place of work is Abuja. Individual must have at least
          ...
          <p className="text-lg">
            ...
            <span className="font-bold">
              recruitment@bfgconsults.com CC. admin@bfgconsults.com
            </span>{" "}
            on or before{" "}
            <span className="font-bold">11:59pm, 30th March, 2024</span>
          </p>
        </div>
      </div>
    </>
