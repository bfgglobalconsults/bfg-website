        ...
        <div className="mx-10">
          ...
          <div className="w-full flex flex-row gap-10">
            <div className="w-[50%] py-30">
              ...
              <div className="my-10">
                <button
                  onClick={open}
                  className="py-2 px-6 bg-[#127DC0] hover:bg-black text-white rounded-2xl"
                >
                  Get Started
                </button>
              </div>
            ...
            <div>
            <div className="w-full flex flex-row gap-20 my-10 mx-10">
              <div className="w-[40%]">
          ...
          <MediaQuery max="lg">
            ...
            <div className="w-full py-30">
              <div className="mt-10">
                <p className="py-2 px-2 border border-[#F1AF88] rounded-3xl inline-block">
                  Introducing Data 2 Deals
                </p>
              </div>
              <div>
                <h3 className="text-4xl text-[#333333] font-mont font-extrabold">
                  Unlock the Power of Data-Driven Deal Making
                </h3>
                <p className="text-[#999999] text-lg">
                  Streamline your construction data management and uncover new
            ...
            <div>
            <div className="w-full text-center py-20">
              <h3 className="text-lg text-[#E26015] font-mont font-bold my-2">
                Why Use Data2Deals
              </h3>
              ...
              <p className="text-lg text-[#596780] font-mont my-2">
                Our platform, Data2Deals, empowers businesses to effectively
                manage
              ...
              <div className="w-[100%]">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-[20px] text-black font-mont my-2 font-bold">
                      Advance Your Sales Team
                    </h4>
                    <p className="text-[#596780]">
                      We equip your team with the latest AI tools and techniques
                      to gain valuable insights, personalize marketing efforts
                      and optimize lead generation. This allows them to target
                      the right audience with the right message, increase their
                      chances of closing deals.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#596780]">
                      Our AI-driven strategies help improve conversion rates,
                      shorten sales cycles, and maximize profitability.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#596780]">
                      We equip your team with the skills and knowledge to
                      leverage AI and stay ahead the curve in the increasingly
                      competitive Real Market.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <figure className="max-w-screen-md mx-auto">
                      ...
                      <blockquote>
                        <p className="text-2xl  text-gray-900 dark:text-white">
                          Our business recently enrolled key team members in an
                          AI training program, and the impact has been
                          transformative. The comprehensive curriculum covered
                          everything from foundational principles to advanced
                          machine learning techniques, tailored to real-world
