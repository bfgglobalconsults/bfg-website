    ...
    <>
      <div>
        ...
        <p className="text-[#656565] px-[40px] py-[30px]">
          In the vibrant world of hospitality and tourism, BFG Global Consulting
          stands as a trusted partner, committed to driving innovation,
          enhancing guest experiences, and fostering sustainable growth. With a
          deep understanding of market trends, consumer preferences, and
          operational challenges, we deliver tailored solutions that empower
          hotels, resorts, travel agencies, and destination management
          organizations to thrive in todays dynamic landscape. From strategic
          planning and revenue optimization to digital transformation and
          sustainability initiatives, our holistic approach enables clients to
          adapt to changing market dynamics, seize new opportunities, and create
          memorable experiences that inspire loyalty and drive success. At BFG
          Global Consulting, we are dedicated to shaping the future of
          hospitality and tourism, one strategic partnership at a time.
        </p>
        <div>
          <div className="bg-[#f8f5f5] p-8">
            <h3 className="text-[#016EF8] text-3xl  lg:text-4xl text-center my-4">
              Areas where we make a difference in the Hospitality and Tourism Sector{" "}
            </h3>
            <div className="w-full flex flex-wrap md:justify-center lg:justify-normal gap-8">
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                ...
                <h4 className="text-2xl my-2">Strategic Planning Services</h4>
                <p className="text-[#656565]">
                  Tailored strategic planning services to help hotels, resorts,
                  and tourism organizations define their vision, set goals, and
              ...
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                ...
                <p className="text-[#656565]">
                  Data-driven revenue management strategies and pricing
                  optimization services to maximize room rates, occupancy
                  levels, and overall revenue for hospitality establishments.
                </p>
              </div>
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                <span>
                ...
                <p className="text-[#656565]">
                  In-depth market research and competitive analysis services to
                  provide insights into market trends, consumer behavior, and
              ...
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                ...
                <p className="text-[#656565]">
                  Comprehensive digital transformation solutions to help
                  hospitality businesses leverage technology and digital
                  channels to streamline operations, improve efficiency, and
              ...
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                ...
                <h4 className="text-2xl my-2">Sustainability Initiatives</h4>
                <p className="text-[#656565]">
                  Guidance and support in implementing sustainable practices and
                  eco-friendly initiatives to reduce environmental impact,
                  increase operational efficiency, and appeal to environmentally
                  conscious travelers.
                </p>
              </div>
              ...
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                ...
                <p className="text-[#656565]">
                  Customized training and development programs for hospitality
                  staff and management teams, covering areas such as customer
                  service, leadership development, and operational excellence to
                  ensure consistent service quality and employee engagement.
                </p>
              </div>
            </div>
          </div>
