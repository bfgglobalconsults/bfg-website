...
import FirstNews from "../../../../../../public/assets/real-estate.jpg";
const page = () => {
  return (
    <>
      <div className="lg:mt-[150px] p-10">
        ...
        <div className="w-full my-4">
          <h3 className="w-[100%]  text-[#333] font-bold text-3xl md:text-3xl lg:text-5xl">
                      Building a Strong Digital Presence: A Professional Website for Alubarika Construction
                  </h3>
        </div>
          ...
          <div className="w-full flex gap-3">
            <div className="w-[100%] lg:w-[80%] bg-[#FCFCFD] border-2 border-[#F7F7F8] rounded-3xl p-5 lg:p-10">
              <p className="text-lg text-[#9b8b8b]">
                              A professionally designed website with seamless navigation, an aesthetically appealing user interface, high-quality content, and fast responsiveness across all devices. This platform enhances Alubarika Construction&apos;s credibility, boosts online visibility, expands client reach, and strengthens its brand presence in the industry.
                          </p>
              <br />
            </div>
        ...
        <div className="p-1 lg:p-12">
          ...
          <div className="w-full flex gap-3">
            <div className="w-[100%] lg:w-[80%] bg-[#FCFCFD] border-2 border-[#F7F7F8] rounded-3xl p-5 lg:p-10">
              <p className="text-lg text-[#9b8b8b]">
Alubarika Constructions Company Limited lacked a professional online platform to effectively showcase its projects, highlight its services, and communicate its portfolio. This absence limited its ability to attract potential clients, generate leads, and engage investors, ultimately hindering business growth and market expansion.              </p>
            </div>
        ...
        <div className="p-1 lg:p-12">
          ...
          <div className="w-full flex gap-3">
            <div className="w-[100%] lg:w-[80%] bg-[#FCFCFD] border-2 border-[#F7F7F8] rounded-3xl p-5 lg:p-10">
              <p className="text-lg text-[#9b8b8b]">
To effectively showcase Alubarika Construction&apos;s projects and expertise in the construction and real estate sectors, we conducted in-depth technical research and UI/UX design analysis. This research guided the development of an interactive website aimed at enhancing the company&apos;s credibility, improving user engagement, and expanding business opportunities.              </p>
            </div>
            <div className="hidden lg:block lg:w-[20%]"></div>
          </div>
        </div>
