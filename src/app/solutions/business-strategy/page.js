            ...
            <h3 className="text-[#016EF8] text-3xl  lg:text-4xl text-center my-4">
              ...
              <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                ...
                <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                  ...
                  <h4 className="text-2xl my-2">                        Business strategy development and implementation
</h4>
                  <p className="text-[#656565]">
                ...
                <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                  ...
                  <h4 className="text-2xl my-2">Operations assessment and optimisation</h4>
                  <p className="text-[#656565]">
                ...
                <div className="w-[100%] md:w-[60%] lg:w-[30%] p-3 bg-white shadow-lg border-b-2 border-[#016EF8]">
                  <span>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="rgba(1,110,248,1)"><path d="M9 13V16H15V13H22V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V13H9ZM11 11H13V14H11V11ZM7 5V2C7 1.44772 7.44772 1 8 1H16C16.5523 1 17 1.44772 17 2V5H21C21.5523 5 22 5.44772 22 6V11H15V9H9V11H2V6C2 5.44772 2.44772 5 3 5H7ZM9 3V5H15V3H9Z"></path></svg>
                  </span>
                  <h4 className="text-2xl my-2">Organisational design and restructuring</h4>
                  <p className="text-[#656565]">
            ...
            <div className="w-full flex gap-4 flex-wrap justify-center">
              ...
              <div className="border-2 rounded-md border-gray-400 p-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xl text-gray-500">
                    Associate, Business Strategy and <br/>Operations
                  </p>
                  <div className="flex gap-2 justify-center my-2">
                    <span>
                      <svg
